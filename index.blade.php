...
<footer class="bg-gray-50 py-4">
    <section class="container text-gray-400">
        ...
        <ul class="flex divide-x divide-gray-300 text-gray-500 leading-none space-x-1 mt-1.5">
            <li><a href="/privacy" class="text-xs md:text-sm">Privacy Policy</a></li>
            <li class="pl-1"><a href="/terms" class="text-xs md:text-sm">Terms and Conditions</a></li>
            <li class="pl-1"><a href="/contact" class="text-xs md:text-sm">Contact Us</a></li>
        </ul>
